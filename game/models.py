...
class Game(models.Model): 
	...
	def create_new_game(user, cols, rows, ships):
		new_game = Game(p1=user, num_cols=cols, num_rows=rows, player_turn=1, p1_ship_count=ships, p2_ship_count=ships, p1_ready=false, p2_ready=false)
		new_game.save()
		return new_game
...
class Cell(models.Model): 
	...
	ship_or_sea = models.ForeignKey(User_Shipyard, on_delete=models.CASCADE)
